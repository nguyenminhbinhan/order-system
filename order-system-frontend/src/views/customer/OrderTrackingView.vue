        ...
        <div class="px-6 py-6 border-t border-slate-100 dark:border-slate-800 pb-24">
          ...
          <div class="space-y-4">
            ...
            >
              ...
              <span class="text-sm font-bold">${{ Number(item.price * item.quantity).toFixed(2) }}</span>
            </div>
            
            <div class="pt-4 flex items-center justify-between border-t border-slate-200 dark:border-slate-700">
              <span class="font-bold text-lg">Total Amount</span>
              <span class="font-bold text-lg text-primary">${{ Number(orderData.totalAmount).toFixed(2) }}</span>
            </div>
